    ...
    def vars_for_template(self):
        ...
        if self.player.income3 == 400:
            competition_msg = ['You have performed well in the competition. Your earnings of 400 tokens have therefore not been reduced. ',
                               'You have not performed well in the competition. Your earnings of 400 tokens have therefore been reduced to 360 tokens. ']
            if self.player.competition == 1:
                income = 360


        else:
            competition_msg = [group_members_info[1]+' has performed well in the competition. Their earnings of 400 tokens have therefore not been reduced. ',
                               group_members_info[1]+' has not performed well in the competition. Their earnings of 400 tokens have therefore been reduced to 360 tokens. ']
